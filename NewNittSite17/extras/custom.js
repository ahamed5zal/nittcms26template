...
//  Selectize
    ...
    if(!$('select').hasClass('tribe-bar-views-select') && !$('select').parent().hasClass('comment-form-rating')){ $('select:not(#childpagetype,#linktype,#linktypeex,#page_template,#menutype,#linkselect,#linkselectex)').selectize(); }
